...
const installationToken:string=installationTokenConfig.Response[0].Token.token;
...
bunqApi.setPubBunqKeyPem(installationTokenConfig.Response[0].ServerPublicKey.server_public_key);
